...
import numpy as np
from CAD1 import ConvolutionalAutoencoder, criterion
...
model.load_state_dict(torch.load('CAD1_best_model.pth', map_location='cpu'))
model.eval()
model.to(device)
...
k = 3  # for example, this value might need to be tuned

# Set the threshold
threshold = mean + k * std

print(f"k-sigma threshold = {threshold}")
